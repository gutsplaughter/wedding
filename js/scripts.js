$(document).ready(function () {
    ...
    $('.wp5A').waypoint(function () {
        $('.wp5A').addClass('animate__animated animate__fadeInLeft');
    }, {
        offset: '75%'
    });
    $('.wp5B').waypoint(function () {
        $('.wp5B').addClass('animate__animated animate__fadeInRight');
    }, {
        offset: '75%'
    });
    ...
    $('.header-nav li a').click(function () {
        $('.nav-toggle').removeClass('active'); // remove active on link click
    ...
    $(function () {
        var lastScrollTop = 0;
        var delta = 5;
        var $navSection = $('section.navigation');
        var navbarHeight = $navSection.outerHeight();
        var ticking = false;
        ...
        function onScroll() {
            ...
            // Scrolling down - hide navigation section
            $navSection.addClass('header-hidden').removeClass('header-visible');
            } else {
            // Scrolling up - show navigation section
            $navSection.addClass('header-visible').removeClass('header-hidden');
            }
